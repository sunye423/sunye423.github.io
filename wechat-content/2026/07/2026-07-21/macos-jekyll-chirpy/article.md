...
summary: "梳理 macOS 上配置独立 Ruby、安装 Jekyll 与 Chirpy、处理常见故障并通过 GitHub Actions 自动部署的完整过程。"
author: "西瓜皮水果糖"
brand: "西瓜皮水果糖"
...
![macOS 博客搭建与发布流程](imgs/01-infographic-build-flow.png)
...
![Jekyll + Chirpy 博客页面预览](imgs/02-site-preview.png)
